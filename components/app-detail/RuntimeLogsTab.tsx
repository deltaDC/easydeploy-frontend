      ...
      <div className="flex gap-1.5">
        {filters.map((filter) => (
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className={`
              pill-filter ${filter.color}
              ${activeFilter === filter.id
                ? "active bg-emerald-100/80 border-emerald-300/50"
                : ""
              }
            `}
          >
    ...
    <div className="space-y-4 animate-fade-in">
      <Card className="glass-card border-0 overflow-hidden shadow-sage-glow">
        ...
        <CardContent className="p-0">
          {/* Terminal Window */}
          <div className="charcoal-glass-dark mx-4 mb-4 rounded-lg overflow-hidden shadow-charcoal-inset relative">
            {/* Terminal Header */}
            <div className="flex items-center gap-2 px-4 py-2 border-b border-white/5">
              ...
              <span className="text-xs text-slate-500 ml-2 font-mono">runtime-logs</span>
              {activeFilter !== "all" && (
            ...
            {error ? (
              ...
              <div className="h-80 flex items-center justify-center">
                <div className="text-center">
                  <div className="glass-shimmer w-64 h-4 rounded mb-2 mx-auto" />
                  <div className="glass-shimmer w-48 h-4 rounded mb-2 mx-auto" />
                  <div className="glass-shimmer w-32 h-4 rounded mx-auto" />
                  <p className="text-slate-500 text-sm mt-4">Đang tải log...</p>
                </div>
              </div>
            ) : (
              <div
