		...
		<Link href={href}>
			<motion.div
				...
				className={`relative flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all duration-300 ${
					active
						? "bg-[#A7F3D0]/10 text-charcoal font-medium"
...
export default function DashboardSidebar() {
	...
	return (
		<aside className="fixed left-0 top-0 h-screen w-[260px] bg-white/45 backdrop-blur-[25px] border-r border-white/18 z-50 flex flex-col">
			{/* Logo Section */}
			...
			{/* Navigation Menu */}
			<nav className="flex-1 px-3 py-6 space-y-2 overflow-y-auto scrollbar-misty">
				{navLinks.map((link) => (
					<SidebarLink
						key={link.href}
						href={link.href}
				...
				<div className="px-4 py-4 border-t border-white/18">
					<div className="flex items-center gap-3 mb-3">
						<div className="relative">
							<Avatar className="h-10 w-10 ring-2 ring-emerald-400/30 ring-offset-2 ring-offset-white/45">
